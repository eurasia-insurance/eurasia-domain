...
CREATE TABLE POS_CONTACT_PHONE (ID INTEGER AUTO_INCREMENT NOT NULL, PHONE_NUMBER LONGBLOB, PHONE_TYPE VARCHAR(255), UPDATED DATETIME NOT NULL, POS_ID INTEGER, PRIMARY KEY (ID))
