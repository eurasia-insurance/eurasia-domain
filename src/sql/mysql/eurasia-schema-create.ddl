...
CREATE TABLE POS (ID INTEGER AUTO_INCREMENT NOT NULL, IS_AVAILABLE TINYINT(1) default 0, NAME VARCHAR(255), UPDATED DATETIME NOT NULL, ADDRESS_CITY VARCHAR(255), ADDRESS_POSTINDEX VARCHAR(255), ADDRESS_STREET VARCHAR(255), PRIMARY KEY (ID))
